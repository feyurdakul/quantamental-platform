...
export const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  return (
    <>
      {/* Mobilde Açılır Karartma Arka Planı (Overlay) */}
      {isMobileOpen && (
        <div 
      ...
      <aside className={`
        ...
        w-64 bg-dark-900 border-r border-slate-800/80 flex flex-col justify-between flex-shrink-0 min-h-screen
      ...
      `}>
        <div>
          ...
          <div 
            ...
            className="p-4 md:p-5 border-b border-slate-800/80 cursor-pointer flex items-center justify-between group"
          >
